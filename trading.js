document.addEventListener('DOMContentLoaded', () => {
    ...
    transactionForm.addEventListener('submit', (e) => {
        ...
        // Effectuez ici la logique pour la transaction en utilisant l'API CoinGecko
        // Par exemple, calculez le montant en fonction du taux de change actuel
        // Enregistrez également la transaction dans localStorage pour l'historique
        // Rafraîchissez l'affichage de l'historique des transactions

        // Exemple de mise à jour de l'historique des transactions
    ...
    // Vous pouvez également mettre en place la mise à jour en temps réel des prix des cryptomonnaies
    // en utilisant setInterval pour effectuer des appels périodiques à l'API CoinGecko.
    // Mettez à jour les prix affichés sur la page.
});
